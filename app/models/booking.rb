class Booking < ActiveRecord::Base
  ...
  def set_values(offer_id,checkin,checkout,guests,guest_id,trip_id)
    ...
    if @offer.included_guest_count && guests.to_i > @offer.included_guest_count && @offer.extra_guest_charge_amount
...
def request_values(offer_id,checkin,checkout,guests)
    checkout = Date.strptime(checkout, "%m/%d/%Y")
    checkin = Date.strptime(checkin, "%m/%d/%Y")
